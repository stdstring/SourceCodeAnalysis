    ...
    public class SourceCheckUtilIntegrationTests
    {
        ...
        public void ProcessBadExampleProjectAnalysis()
        {
            ...
            const String expectedErrorTemplate = "[ERROR]: {0}\\CastsExample.cs file contains the cast to the same type string which are started at 25,28 and finished at 25,44\r\n" +
                                                 ...
                                                 "[ERROR]: {0}\\VirtualInheritanceExample.cs file contains BadExample.ISomeParentInterfaceA type which implements the following base non-system interfaces not marked for virtual inheritance in the ported C++ code: BadExample.ISomeGrandParentInterfaceA, BadExample.ISomeGrandParentInterfaceC\r\n" +
                                                 "[ERROR]: {0}\\VirtualInheritanceExample.cs file contains BadExample.ISomeParentInterfaceB type which implements the following base non-system interfaces not marked for virtual inheritance in the ported C++ code: BadExample.ISomeGrandParentInterfaceB\r\n" +
                                                 "[ERROR]: {0}\\VirtualInheritanceExample.cs file contains BadExample.ISomeChildInterfaceA type which implements the following base non-system interfaces not marked for virtual inheritance in the ported C++ code: BadExample.ISomeGrandParentInterfaceA, BadExample.ISomeGrandParentInterfaceC\r\n" +
                                                 "[ERROR]: {0}\\VirtualInheritanceExample.cs file contains BadExample.ISomeChildInterfaceB type which implements the following base non-system interfaces not marked for virtual inheritance in the ported C++ code: BadExample.ISomeGrandParentInterfaceB\r\n" +
                                                 "[ERROR]: {0}\\VirtualInheritanceExample.cs file contains BadExample.SomeClassA type which implements the following base non-system interfaces not marked for virtual inheritance in the ported C++ code: BadExample.ISomeGrandParentInterfaceA, BadExample.ISomeGrandParentInterfaceC\r\n" +
                                                 "[ERROR]: {0}\\VirtualInheritanceExample.cs file contains BadExample.SomeClassB type which implements the following base non-system interfaces not marked for virtual inheritance in the ported C++ code: BadExample.ISomeGrandParentInterfaceB\r\n";
